...
.field protected static licensePubKey:Ljava/lang/String; = ""
...
.field protected static packageName:Ljava/lang/String; = "com.martindoudera.cashreader"
...
.method public static synthetic $r8$lambda$heJ2Stw6wCNVkkwCytXyCvBISDM(Lcom/pairip/licensecheck/LicenseClient;)V
    ...
    invoke-direct {v0}, Lcom/pairip/licensecheck/LicenseClient;->lambda$scheduleRepeatedLicenseCheck$0()V
...
.method public static synthetic $r8$lambda$tTRuJInP7s484yRu-m6AsnoI1z4(Lcom/pairip/licensecheck/LicenseClient;)V
    ...
    invoke-direct {v0}, Lcom/pairip/licensecheck/LicenseClient;->connectToLicensingService()V
...
.method private checkLicenseInternal(Landroid/os/IBinder;)V
    ...
    const-string v9, "Licensing service process died."
...
.method private connectToLicensingService()V
    ...
    const-string v5, "Connecting to the licensing service..."
    ...
    const-string v5, "Could not bind with the licensing service."
    ...
    invoke-direct {v3, v0}, Lcom/pairip/licensecheck/LicenseClient;->retryOrThrow(Lcom/pairip/licensecheck/LicenseCheckException;)V
    ...
    const-string v5, "Not allowed to bind with the licensing service."
    ...
    invoke-direct {v3, v1}, Lcom/pairip/licensecheck/LicenseClient;->retryOrThrow(Lcom/pairip/licensecheck/LicenseCheckException;)V
...
.method private synthetic lambda$initializeLicenseCheck$0()V
    ...
    invoke-direct {v2, v3, v0}, Lcom/pairip/licensecheck/LicenseClient$$ExternalSyntheticLambda1;-><init>(Lcom/pairip/licensecheck/LicenseClient;Z)V
...
.method private synthetic lambda$onServiceConnected$0(Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, p1}, Lcom/pairip/licensecheck/LicenseClient;->checkLicenseInternal(Landroid/os/IBinder;)V
    :try_end_0
    ...
    .line 243
    invoke-direct {v0, p1}, Lcom/pairip/licensecheck/LicenseClient;->handleError(Lcom/pairip/licensecheck/LicenseCheckException;)V
...
.method private synthetic lambda$onServiceConnected$1(Landroid/os/IBinder;)V
    ...
    const-string v5, "Error while reporting license check: "
...
.method private synthetic lambda$processResponse$0(Lcom/pairip/licensecheck/RepeatedCheckMetadata;Landroid/os/Bundle;)V
    ...
    .line 425
    invoke-direct {v1, p1}, Lcom/pairip/licensecheck/LicenseClient;->scheduleRepeatedLicenseCheck(Lcom/pairip/licensecheck/RepeatedCheckMetadata;)V
...
.method private synthetic lambda$scheduleRepeatedLicenseCheck$0()V
    ...
    .line 457
    iput-boolean v0, v1, Lcom/pairip/licensecheck/LicenseClient;->waitingForRepeatedCheck:Z

    const/4 v3, 0x6

    .line 458
    invoke-direct {v1}, Lcom/pairip/licensecheck/LicenseClient;->connectToLicensingService()V
...
.method private performLocalInstallerCheck()Z
    ...
    .line 170
    const-string v8, "Local install check bypassed due to old SDK version."
    ...
    .line 191
    const-string v8, "Local install check bypassed due to install source info not found."
    ...
    :goto_0
    const-string v8, "Local install check failed due to wrong installer."
    ...
    :goto_2
    const-string v8, "Local install check bypassed due to app package info not found."
    ...
    .line 201
    const-string v8, "Could not obtain package info for local installer check."
...
.method private retryOrThrow(Lcom/pairip/licensecheck/LicenseCheckException;)V
    ...
    .line 383
    invoke-direct {v1, p1, v0}, Lcom/pairip/licensecheck/LicenseClient;->retryOrThrow(Lcom/pairip/licensecheck/LicenseCheckException;Z)V
...
.method private retryOrThrow(Lcom/pairip/licensecheck/LicenseCheckException;Z)V
    ...
    invoke-direct {v3, v6}, Lcom/pairip/licensecheck/LicenseClient$$ExternalSyntheticLambda0;-><init>(Lcom/pairip/licensecheck/LicenseClient;)V
    ...
    .line 397
    const-string v8, "Retry #%d. License check failed with error \'%s\'. Next try in %ds..."
    ...
    const-string v8, "Retry limit reached for: "
...
.method private scheduleRepeatedLicenseCheck(Lcom/pairip/licensecheck/RepeatedCheckMetadata;)V
    ...
    iget-object v3, v7, Lcom/pairip/licensecheck/LicenseClient;->context:Landroid/content/Context;
    ...
    .line 453
    const-string v10, "Failed to unbind service for repeated license check."
    ...
    .line 455
    :goto_0
    iget-object v3, v7, Lcom/pairip/licensecheck/LicenseClient;->delayedTaskExecutor:Lcom/pairip/licensecheck/LicenseClient$DelayedTaskExecutor;
    ...
    invoke-direct {v4, v7}, Lcom/pairip/licensecheck/LicenseClient$$ExternalSyntheticLambda9;-><init>(Lcom/pairip/licensecheck/LicenseClient;)V
...
.method public initializeLicenseCheck()V
    ...
    invoke-direct {v2}, Lcom/pairip/licensecheck/LicenseClient;->connectToLicensingService()V
    ...
    invoke-direct {v1, v2}, Lcom/pairip/licensecheck/LicenseClient$$ExternalSyntheticLambda4;-><init>(Lcom/pairip/licensecheck/LicenseClient;)V
...
.method public reportSuccessfulLicenseCheck(Landroid/os/IBinder;)V
    ...
    invoke-direct {v8, p1, v2}, Lcom/pairip/licensecheck/LicenseClient;->retryOrThrow(Lcom/pairip/licensecheck/LicenseCheckException;Z)V
    ...
    invoke-direct {v8, v1, v2}, Lcom/pairip/licensecheck/LicenseClient;->retryOrThrow(Lcom/pairip/licensecheck/LicenseCheckException;Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
