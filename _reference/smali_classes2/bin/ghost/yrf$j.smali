.class public final Lbin/ghost/yrf$j;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lbin/ghost/yrf$c;

    const-class v1, Lbin/ghost/yrf$b;

    const-class v2, Lbin/ghost/yrf$h;

    new-instance v3, Ljava/util/HashSet;

    invoke-direct {v3}, Ljava/util/HashSet;-><init>()V

    sput-object v3, Lbin/ghost/yrf$j;->f:Ljava/util/HashSet;
    ...
    sput-object v3, Lbin/ghost/yrf$j;->a:Lsun/misc/Unsafe;
    ...
    sput-wide v6, Lbin/ghost/yrf$j;->b:J
    ...
    const-class v0, Lbin/ghost/yrf$f;
    ...
    const-class v0, Lbin/ghost/yrf$g;
    ...
    sput-wide v8, Lbin/ghost/yrf$j;->c:J
    ...
    const-class v0, Lbin/ghost/yrf$d;
    ...
    invoke-static {}, Lbin/ghost/yrf$i;->c()Ljava/lang/invoke/MethodHandles$Lookup;

    move-result-object v5

    invoke-static {v5, v0}, Lbin/ghost/yrf$i;->b(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Method;)Ljava/lang/invoke/MethodHandle;
    ...
    invoke-static {v5, v1}, Lbin/ghost/yrf$i;->b(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Method;)Ljava/lang/invoke/MethodHandle;
    ...
    sput-wide v0, Lbin/ghost/yrf$j;->d:J

    sub-long/2addr v12, v8

    sub-long/2addr v12, v0

    sput-wide v12, Lbin/ghost/yrf$j;->e:J
    ...
    invoke-static {v4, v0}, Lbin/ghost/yrf$i;->a(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Field;)Ljava/lang/invoke/MethodHandle;
    ...
    invoke-static {v4, v1}, Lbin/ghost/yrf$i;->a(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Field;)Ljava/lang/invoke/MethodHandle;
...
.method public static varargs a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-class v5, Lbin/ghost/yrf$e;
    ...
    sget-object v5, Lbin/ghost/yrf$j;->a:Lsun/misc/Unsafe;

    sget-wide v6, Lbin/ghost/yrf$j;->c:J
    ...
    sget-wide v9, Lbin/ghost/yrf$j;->d:J

    mul-long v7, v7, v9

    add-long/2addr v7, v13

    sget-wide v9, Lbin/ghost/yrf$j;->e:J

    add-long v11, v7, v9

    sget-object v7, Lbin/ghost/yrf$j;->a:Lsun/misc/Unsafe;

    sget-wide v9, Lbin/ghost/yrf$j;->b:J
...
.method public static varargs b([Ljava/lang/String;)Z
    ...
    invoke-static {v3, v6, v4, v5}, Lbin/ghost/yrf$j;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v3, v2, v5}, Lbin/ghost/yrf$j;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
