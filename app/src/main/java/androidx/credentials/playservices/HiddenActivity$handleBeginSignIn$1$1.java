...
public final class HiddenActivity$handleBeginSignIn$1$1 extends AbstractC1584Bt implements InterfaceC2855Wl {
    ...
    public final void invoke(BeginSignInResult beginSignInResult) {
        try {
            ...
            this.this$0.startIntentSenderForResult(beginSignInResult.f3241else.getIntentSender(), this.$requestCode, null, 0, 0, 0, null);
