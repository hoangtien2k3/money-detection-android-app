...
public final class HiddenActivity$handleCreatePublicKeyCredential$1$1 extends AbstractC1584Bt implements InterfaceC2855Wl {
    ...
    public final void invoke(PendingIntent pendingIntent) {
        AbstractC4625zr.m14149public("result", pendingIntent);
        try {
