...
final class zzg extends com.google.android.gms.internal.fido.zzq {
    ...
    public final /* synthetic */ TaskCompletionSource f4082abstract;

    public zzg(TaskCompletionSource taskCompletionSource) {
        this.f4082abstract = taskCompletionSource;
    }
    ...
    public final void mo2832goto(Status status, PendingIntent pendingIntent) {
        TaskUtil.m2602else(status, pendingIntent, this.f4082abstract);
    }
}
