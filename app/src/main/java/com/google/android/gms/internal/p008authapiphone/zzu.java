...
final class zzu extends IStatusCallback.Stub {
    ...
    public final /* synthetic */ TaskCompletionSource f4146abstract;

    public zzu(TaskCompletionSource taskCompletionSource) {
        this.f4146abstract = taskCompletionSource;
    }
    ...
    public final void mo200r(Status status) {
        ...
        TaskCompletionSource taskCompletionSource = this.f4146abstract;
        if (i == 6) {
