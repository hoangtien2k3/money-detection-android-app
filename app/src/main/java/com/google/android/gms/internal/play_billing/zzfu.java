...
final class zzfu {
    ...
    public static final zzfs f5312else;

    static {
        if (zzfp.f5310package && zzfp.f5309instanceof) {
    ...
    */
    public static int m4337abstract(int i, int i2, String str, byte[] bArr) {
        int i3;
        int i4;
        int i5;
        char cCharAt;
    ...
    public static int m4338default(String str) {
        int length = str.length();
        int i = 0;
        int i2 = 0;
    ...
    /* JADX INFO: renamed from: else, reason: not valid java name */
    public static /* bridge */ /* synthetic */ int m4339else(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 != 0) {
            if (i3 == 1) {
