...
public final /* synthetic */ class zan implements RemoteCall {
    ...
    public final void mo2598else(Api.AnyClient anyClient, TaskCompletionSource taskCompletionSource) {
        zaw zawVar = new zaw(taskCompletionSource);
        zaf zafVar = (zaf) ((zaz) anyClient).m2661strictfp();
        Parcel parcelM3011strictfp = zafVar.m3011strictfp();
        com.google.android.gms.internal.base.zac.m3015instanceof(parcelM3011strictfp, zawVar);
        parcelM3011strictfp.writeInt(0);
        zafVar.m3010static(parcelM3011strictfp, 3);
    }
}
