...
final class zzt extends com.google.android.gms.internal.fido.zzl {
    ...
    public final /* synthetic */ TaskCompletionSource f4089abstract;

    public zzt(TaskCompletionSource taskCompletionSource) {
        this.f4089abstract = taskCompletionSource;
    }
    ...
    public final void mo2834goto(Status status, PendingIntent pendingIntent) {
        TaskUtil.m2602else(status, new com.google.android.gms.internal.fido.zzi(), this.f4089abstract);
    }
}
