...
final class zzf extends com.google.android.gms.internal.fido.zzq {
    ...
    public final /* synthetic */ TaskCompletionSource f4081abstract;

    public zzf(TaskCompletionSource taskCompletionSource) {
        this.f4081abstract = taskCompletionSource;
    }
    ...
    public final void mo2832goto(Status status, PendingIntent pendingIntent) {
        TaskUtil.m2602else(status, pendingIntent, this.f4081abstract);
    }
}
