...
final class zzh extends com.google.android.gms.internal.fido.zzq {
    ...
    public final /* synthetic */ TaskCompletionSource f4083abstract;

    public zzh(TaskCompletionSource taskCompletionSource) {
        this.f4083abstract = taskCompletionSource;
    }
    ...
    public final void mo2832goto(Status status, PendingIntent pendingIntent) {
        TaskUtil.m2602else(status, new com.google.android.gms.internal.fido.zzi(), this.f4083abstract);
    }
}
