    ...
    public final Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iM2695const) {
            ...
            if (c == 1) {
                ...
                field = (FastJsonResponse.Field) SafeParcelReader.m2705package(parcel, i, FastJsonResponse.Field.CREATOR);
            }
        }
        SafeParcelReader.m2712throws(parcel, iM2695const);
        return new zam(iM2699extends, strM2706protected, field);
    }
