...
public final class zbs implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iM2695const) {
            ...
            char c = (char) i;
            if (c == 1) {
                signInPassword = (SignInPassword) SafeParcelReader.m2705package(parcel, i, SignInPassword.CREATOR);
            } else if (c == 2) {
        ...
        return new SavePasswordRequest(signInPassword, strM2706protected, iM2699extends);
    }
