...
public final class SchedulerModule_ProvidesComputeSchedulerFactory implements Factory<AbstractC2160LJ> {

    /* JADX INFO: renamed from: else, reason: not valid java name */
    public final SchedulerModule f10774else;

    public SchedulerModule_ProvidesComputeSchedulerFactory(SchedulerModule schedulerModule) {
        this.f10774else = schedulerModule;
    }

    @Override // p006o.InterfaceC3613jF
    public final Object get() {
        this.f10774else.getClass();
