...
public final class InflaterConfigModule_ProvidesModalLandscapeConfigFactory implements Factory<InAppMessageLayoutConfig> {
    ...
    public final InflaterConfigModule_ProvidesDisplayMetricsFactory f10454abstract;

    /* JADX INFO: renamed from: else, reason: not valid java name */
    public final InflaterConfigModule f10455else;
    ...
    public InflaterConfigModule_ProvidesModalLandscapeConfigFactory(InflaterConfigModule inflaterConfigModule, InflaterConfigModule_ProvidesDisplayMetricsFactory inflaterConfigModule_ProvidesDisplayMetricsFactory) {
        this.f10455else = inflaterConfigModule;
        this.f10454abstract = inflaterConfigModule_ProvidesDisplayMetricsFactory;
    }

    @Override // p006o.InterfaceC3613jF
    public final Object get() {
        DisplayMetrics displayMetrics = (DisplayMetrics) this.f10454abstract.get();
        this.f10455else.getClass();
        ...
        inAppMessageLayoutConfig.f10312abstract = Float.valueOf(0.4f);
        inAppMessageLayoutConfig.f10321protected = 17;
        inAppMessageLayoutConfig.f10320package = 327938;
        inAppMessageLayoutConfig.f10315continue = -1;
        inAppMessageLayoutConfig.f10314case = -1;
