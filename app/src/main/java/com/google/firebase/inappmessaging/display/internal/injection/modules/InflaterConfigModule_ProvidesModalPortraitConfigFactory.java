...
public final class InflaterConfigModule_ProvidesModalPortraitConfigFactory implements Factory<InAppMessageLayoutConfig> {
    ...
    public final InflaterConfigModule_ProvidesDisplayMetricsFactory f10456abstract;

    /* JADX INFO: renamed from: else, reason: not valid java name */
    public final InflaterConfigModule f10457else;
    ...
    public InflaterConfigModule_ProvidesModalPortraitConfigFactory(InflaterConfigModule inflaterConfigModule, InflaterConfigModule_ProvidesDisplayMetricsFactory inflaterConfigModule_ProvidesDisplayMetricsFactory) {
        this.f10457else = inflaterConfigModule;
        this.f10456abstract = inflaterConfigModule_ProvidesDisplayMetricsFactory;
    }

    @Override // p006o.InterfaceC3613jF
    public final Object get() {
        DisplayMetrics displayMetrics = (DisplayMetrics) this.f10456abstract.get();
        this.f10457else.getClass();
        ...
        inAppMessageLayoutConfig.f10312abstract = Float.valueOf(0.9f);
