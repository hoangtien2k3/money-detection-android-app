...
public final class FieldType {
    ...
    private final int f961id;
    private final JavaType javaType;
    private final boolean primitiveScalar;

    /* JADX INFO: renamed from: com.google.crypto.tink.shaded.protobuf.FieldType$1 */
    /* JADX INFO: compiled from: r8-map-id-40d59183bd07d68ef2d4bf0775267fedf46c31b905f5ae28226702cf5c6f4176 */
    public static /* synthetic */ class C09481 {

        /* JADX INFO: renamed from: abstract, reason: not valid java name */
        public static final /* synthetic */ int[] f8911abstract;

        /* JADX INFO: renamed from: else, reason: not valid java name */
        public static final /* synthetic */ int[] f8912else;
        ...
        static {
            ...
            try {
                f8911abstract[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8911abstract[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f8912else[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f8912else[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f961id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C09481.f8912else[collection.ordinal()];
        boolean z = true;
        if (i4 == 1 || i4 == 2) {
        ...
        if (collection != Collection.SCALAR || (i3 = C09481.f8911abstract[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) {
            z = false;
        }
