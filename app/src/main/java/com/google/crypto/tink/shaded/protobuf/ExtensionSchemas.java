...
final class ExtensionSchemas {
    ...
    public static final ExtensionSchema f8902abstract;

    /* JADX INFO: renamed from: else, reason: not valid java name */
    public static final ExtensionSchemaLite f8903else = new ExtensionSchemaLite();
