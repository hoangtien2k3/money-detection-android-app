...
public final class FieldType {
    ...
    public static /* synthetic */ class C13941 {
        ...
        public static final /* synthetic */ int[] f11969abstract;

        /* JADX INFO: renamed from: else, reason: not valid java name */
        public static final /* synthetic */ int[] f11970else;
        ...
        static {
            ...
            try {
                f11969abstract[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11969abstract[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f11970else[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f11970else[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f1049id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C13941.f11970else[collection.ordinal()];
        boolean z = true;
        if (i4 == 1 || i4 == 2) {
        ...
        if (collection != Collection.SCALAR || (i3 = C13941.f11969abstract[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) {
            z = false;
        }
    ...
    private static java.lang.reflect.Type getListParameter(Class<?> cls, java.lang.reflect.Type[] typeArr) {
        ...
        while (true) {
            ...
            java.lang.reflect.Type genericSuperList = getGenericSuperList(superclass);
