...
public final class Field extends GeneratedMessageLite<Field, Builder> implements FieldOrBuilder {
    ...
    public static /* synthetic */ class C13881 {
        ...
        public static final /* synthetic */ int[] f11958else;
        ...
        static {
            ...
            try {
                f11958else[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11958else[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f11958else[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f11958else[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f11958else[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f11958else[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public enum Cardinality implements Internal.EnumLite {
        ...
        public static final class CardinalityVerifier implements Internal.EnumVerifier {
            ...
            /* JADX INFO: renamed from: else, reason: not valid java name */
            public static final Internal.EnumVerifier f11959else = new CardinalityVerifier();
        ...
        public static Internal.EnumVerifier internalGetVerifier() {
            return CardinalityVerifier.f11959else;
        }
    ...
    public enum Kind implements Internal.EnumLite {
        ...
        public static final class KindVerifier implements Internal.EnumVerifier {
            ...
            /* JADX INFO: renamed from: else, reason: not valid java name */
            public static final Internal.EnumVerifier f11960else = new KindVerifier();
        ...
        public static Internal.EnumVerifier internalGetVerifier() {
            return KindVerifier.f11960else;
        }
    ...
    static {
        ...
        GeneratedMessageLite.m1401b(Field.class, field);
    }
    ...
    public final Object mo5367strictfp(GeneratedMessageLite.MethodToInvoke methodToInvoke, GeneratedMessageLite generatedMessageLite) {
        ...
        int i = 0;
        switch (C13881.f11958else[methodToInvoke.ordinal()]) {
            case 1:
                return new Field();
            case 2:
