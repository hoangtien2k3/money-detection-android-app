...
public final class SettingsVibrationActivity extends AbstractActivityC2994Z1 {

    /* JADX INFO: renamed from: r */
    public C4698Lpt3 f1123r;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        View viewInflate = getLayoutInflater().inflate(R.layout.activity_settings_vibration, (ViewGroup) null, false);
        ...
        if (((FragmentContainerView) AbstractC2451Q6.m10995default(viewInflate, R.id.activity_settings_content)) != null) {
            ...
            if (viewM10995default != null) {
                ...
                this.f1123r = new C4698Lpt3(linearLayout, new C3928oP((Toolbar) viewM10995default));
                setContentView(linearLayout);
                C4698Lpt3 c4698Lpt3 = this.f1123r;
                if (c4698Lpt3 == null) {
                ...
                abstractC2688U0M11942return.mo1619c(getString(R.string.vibrations_title));
                return;
            }
        }
