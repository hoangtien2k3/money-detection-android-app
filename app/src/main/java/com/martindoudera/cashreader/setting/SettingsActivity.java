...
public final class SettingsActivity extends AbstractActivityC2994Z1 {

    /* JADX INFO: renamed from: r */
    public C4698Lpt3 f1094r;
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (((FragmentContainerView) AbstractC2451Q6.m10995default(viewInflate, R.id.activity_settings_content)) != null) {
            ...
            if (viewM10995default != null) {
                ...
                this.f1094r = new C4698Lpt3(linearLayout, new C3928oP((Toolbar) viewM10995default));
                setContentView(linearLayout);
                C4698Lpt3 c4698Lpt3 = this.f1094r;
                if (c4698Lpt3 == null) {
                ...
                abstractC2688U0M11942return.mo1619c(getString(R.string.settings_title));
                return;
            }
        }
