...
public final class C1582Br extends AbstractC3330eb {

    /* JADX INFO: renamed from: instanceof, reason: not valid java name */
    public int f12536instanceof;

    /* JADX INFO: renamed from: volatile, reason: not valid java name */
    public final /* synthetic */ InterfaceC2855Wl f12537volatile;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1582Br(InterfaceC3270db interfaceC3270db, InterfaceC4548yb interfaceC4548yb, InterfaceC2855Wl interfaceC2855Wl) {
        super(interfaceC3270db, interfaceC4548yb);
        this.f12537volatile = interfaceC2855Wl;
    ...
    public final Object mo5353break(Object obj) {
        int i = this.f12536instanceof;
        if (i != 0) {
            if (i != 1) {
                throw new IllegalStateException("This coroutine had already completed");
            }
            this.f12536instanceof = 2;
            AbstractC3776lw.m12816class(obj);
            return obj;
        }
        this.f12536instanceof = 1;
        AbstractC3776lw.m12816class(obj);
        InterfaceC2855Wl interfaceC2855Wl = this.f12537volatile;
