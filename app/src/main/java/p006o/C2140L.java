...
public final class C2140L extends MultiAutoCompleteTextView implements InterfaceC3564iP {

    /* JADX INFO: renamed from: instanceof, reason: not valid java name */
    public static final int[] f14395instanceof = {R.attr.popupBackground};

    /* JADX INFO: renamed from: abstract, reason: not valid java name */
    public final C3781m0 f14396abstract;

    /* JADX INFO: renamed from: default, reason: not valid java name */
    public final C2322O f14397default;

    /* JADX INFO: renamed from: else, reason: not valid java name */
    public final C4693LpT7 f14398else;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2140L(Context context, AttributeSet attributeSet) {
        ...
        C4574z0 c4574z0M1785f = C4574z0.m1785f(getContext(), attributeSet, f14395instanceof, com.martindoudera.cashreader.R.attr.autoCompleteTextViewStyle);
    ...
    public final void drawableStateChanged() {
        ...
        C4693LpT7 c4693LpT7 = this.f14398else;
        if (c4693LpT7 != null) {
            c4693LpT7.m10595else();
        }
        C3781m0 c3781m0 = this.f14396abstract;
        if (c3781m0 != null) {
            c3781m0.m12841abstract();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f14396abstract.m12846instanceof();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f14396abstract.m12847package();
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f14397default.m10759extends(inputConnectionOnCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f14397default.m10764import(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f14397default.m10774super(keyListener));
    }
