...
/* JADX INFO: renamed from: o.x5 */
/* JADX INFO: compiled from: r8-map-id-40d59183bd07d68ef2d4bf0775267fedf46c31b905f5ae28226702cf5c6f4176 */
/* JADX INFO: loaded from: classes.dex */
public class C4457x5 extends C4396w5 {
    @Override // p006o.C4396w5, p006o.C2322O
    ...
    public void mo10770public(C2769VK c2769vk) throws CameraAccessException {
        ...
        if (c2251MqMo11196abstract != null) {
            cameraDevice.createReprocessableCaptureSessionByConfigurations(c2251MqMo11196abstract.f14728else.f14374else, C2769VK.m11466else(listMo11202protected), c3725l5, handler);
        } else if (interfaceC2708UK.mo11200instanceof() == 1) {
            cameraDevice.createConstrainedHighSpeedCaptureSession(C2322O.m10748switch(listMo11202protected), c3725l5, handler);
        } else {
            cameraDevice.createCaptureSessionByOutputConfigurations(C2769VK.m11466else(listMo11202protected), c3725l5, handler);
        }
    }
}
