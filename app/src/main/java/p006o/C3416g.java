...
public class C3416g extends CheckBox implements InterfaceC3564iP {

    /* JADX INFO: renamed from: abstract, reason: not valid java name */
    public final C4693LpT7 f17525abstract;

    /* JADX INFO: renamed from: default, reason: not valid java name */
    public final C3781m0 f17526default;

    /* JADX INFO: renamed from: else, reason: not valid java name */
    public final C3538i f17527else;

    /* JADX INFO: renamed from: instanceof, reason: not valid java name */
    public C1896H f17528instanceof;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3416g(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AbstractC3442gP.m12312else(context);
        AbstractC2590SO.m11206else(this, getContext());
        C3538i c3538i = new C3538i(this);
        this.f17527else = c3538i;
        c3538i.m12454instanceof(attributeSet, i);
        C4693LpT7 c4693LpT7 = new C4693LpT7(this);
        this.f17525abstract = c4693LpT7;
        c4693LpT7.m10604public(attributeSet, i);
        C3781m0 c3781m0 = new C3781m0(this);
        this.f17526default = c3781m0;
    ...
    private C1896H getEmojiTextViewHelper() {
        if (this.f17528instanceof == null) {
            this.f17528instanceof = new C1896H(this);
        }
        return this.f17528instanceof;
    }

    @Override // android.widget.CompoundButton, android.widget.TextView, android.view.View
    public void drawableStateChanged() {
        super.drawableStateChanged();
        C4693LpT7 c4693LpT7 = this.f17525abstract;
        if (c4693LpT7 != null) {
            c4693LpT7.m10595else();
        }
        C3781m0 c3781m0 = this.f17526default;
        if (c3781m0 != null) {
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f17526default.m12846instanceof();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f17526default.m12847package();
    }
