...
public abstract class AbstractC2149L8 {
    static {
        new ThreadLocal();
    }

    /* JADX INFO: renamed from: abstract, reason: not valid java name */
    public static int m10454abstract(int i, int i2) {
        int iAlpha = Color.alpha(i2);
        int iAlpha2 = Color.alpha(i);
        int i3 = 255 - (((255 - iAlpha2) * (255 - iAlpha)) / 255);
        return Color.argb(i3, m10455default(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), m10455default(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), m10455default(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }

    /* JADX INFO: renamed from: default, reason: not valid java name */
    public static int m10455default(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
    ...
    public static int m10456else(double d, double d2, double d3) {
    ...
    public static int m10457instanceof(int i, int i2) {
        if (i2 < 0 || i2 > 255) {
