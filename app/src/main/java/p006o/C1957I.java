...
public class C1957I extends ImageButton {

    /* JADX INFO: renamed from: abstract, reason: not valid java name */
    public final C2018J f13918abstract;

    /* JADX INFO: renamed from: default, reason: not valid java name */
    public boolean f13919default;

    /* JADX INFO: renamed from: else, reason: not valid java name */
    public final C4693LpT7 f13920else;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1957I(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        AbstractC3442gP.m12312else(context);
        this.f13919default = false;
        AbstractC2590SO.m11206else(this, getContext());
        C4693LpT7 c4693LpT7 = new C4693LpT7(this);
        this.f13920else = c4693LpT7;
        c4693LpT7.m10604public(attributeSet, i);
        C2018J c2018j = new C2018J(this);
        this.f13918abstract = c2018j;
    ...
    public final void drawableStateChanged() {
        ...
        C4693LpT7 c4693LpT7 = this.f13920else;
        if (c4693LpT7 != null) {
            c4693LpT7.m10595else();
        }
        C2018J c2018j = this.f13918abstract;
        if (c2018j != null) {
            c2018j.m10223else();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f13918abstract.f14032abstract).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C2018J c2018j = this.f13918abstract;
        if (c2018j != null && drawable != null && !this.f13919default) {
            c2018j.f14034else = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        if (c2018j != null) {
            c2018j.m10223else();
            if (!this.f13919default) {
